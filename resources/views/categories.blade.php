...
@section('content_header')
  <div class="pl-3 pt-3">
    <h1>Category</h1>
    <a href="javascript:void(0)" class="btn btn-primary mt-3" id="create-new-category" onclick="addCategory()">Create Category</a>
  </div>
@stop
      ...
      let _token   = $('meta[name="csrf-token"]').attr('content');
        ...
        $.ajax({
          ...
          error: function(response) {
            $('#categoryError').text(response.responseJSON.errors.name);
